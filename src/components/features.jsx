...
export const Features = () => {
  ...
  const handleFeatureIconClick = (featureId) => {
    navigate("/features", { state: { featureId } });
  };
        ...
        <div className="row">
          <div className="col-xs-12 col-md-3">
              ...
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={()=>{handleFeatureIconClick("#availabilitysection")}}
              >
          ...
          <div className="col-xs-12 col-md-3">
              ...
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={()=>{handleFeatureIconClick("#diversesection")}}
          ...
          <div className="col-xs-12 col-md-3">
              ...
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={()=>{handleFeatureIconClick("#researchsection")}}
              >
          ...
          <div className="col-xs-12 col-md-3">
              ...
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={()=>{handleFeatureIconClick("#experiencedsection")}}
              >
