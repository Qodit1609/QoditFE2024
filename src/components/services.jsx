...
export const Services = () => {
  ...
  const handleServiceIconClick = (serviceId) => {
        ...
        <div className="row">
          <div className="col-md-4">
            <svg
              ...
              fill="currentColor"
              className="bi bi-code-slash icondesign"
              viewBox="0 0 16 16"
              id="web"
              placeholder="web"
              onClick={() => handleServiceIconClick("#webdevelopmentsection")}
            >
            ...
            <div className="service-desc">
              ...
              <p style={paraLength}>
                ...
                engagement. Our user-centred web app is feature-rich, intuitive,
                and performs exceedingly well. We craft your web destination
                with a clear view of the business goal and ensure that it
                supports the user-journey.
              </p>
            </div>
          </div>
          ...
          <div className="col-md-4">
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={() => handleServiceIconClick("#systemdevelopmentsection")}
              >
          ...
          <div className="col-md-4">
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={() => handleServiceIconClick("#productdevelopmentsection")}
              >
          ...
          <div className="col-md-4">
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={() => handleServiceIconClick("#mvpsection")}
              >
          ...
          <div className="col-md-4">
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={() => handleServiceIconClick("#cloudservicesection")}
              >
          ...
          <div className="col-md-4">
              <svg
                ...
                viewBox="0 0 16 16"
                onClick={() => handleServiceIconClick("#dataengineeringsection")}
              >
